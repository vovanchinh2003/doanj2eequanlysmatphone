...
<link rel="stylesheet" type="text/css"
	href="http://localhost:8080/doanj2eequanlysmatphone/assetss/css/index.css">
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<form
		action="http://localhost:8080/doanj2eequanlysmatphone/view/add.jsp"
		method="POST">
		<div id="cart" style="padding: 20px 100px;">
			<div class="row">
				<div class="col-md-6 form">
					...
					%>
					<div class="mb-3">
						<input type="hidden" value="<%=MaKhachHang%>	"
							class="form-control" id="ten_khachhang" name="makh"> <label
							for="ten_khachhang" class="form-label">Tên khách hàng:</label> <input
							type="text" value="<%=TenKhachHang%>" class="form-control"
							id="ten_khachhang" name="ten_khachhang">
					</div>
					<div class="mb-3">
						<label for="DiaChi" class="form-label">Địa chỉ:</label> <input
							type="text" value="<%=DiaChi%>" class="form-control" id="DiaChi"
							name="DiaChi">
					</div>
					<div class="mb-3">
						<label for="SoDienThoai" class="form-label">Số điện thoại:</label>
						<input type="text" value="<%=SoDienThoai%>" class="form-control"
							id="SoDienThoai" name="SoDienThoai">
					</div>
					<div class="mb-3">
						<label for="Email" class="form-label">Email:</label> <input
							type="text" value="<%=Email%>" class="form-control" id="Email"
							name="Email">
					</div>
					<%
					}
				...
				<div class="col-md-6">
					...
					<div class="card">
						<div class="card-body">
							...
							<input type="submit" name="add_to_database"
								class="btn btn-success" value="Đặt hàng" />
						</div>
					</div>
				</div>
			</div>
